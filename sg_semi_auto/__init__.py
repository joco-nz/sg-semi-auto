...
"""Main entry point for sg_semi_auto.
...
Example:
    ...
    launch sg_semi_auto by saying::

        $ sg_semi_auto --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='sg_semi_auto',
                          vcp_name='sg_semi_auto',
